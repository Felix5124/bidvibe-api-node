...
const getMyActiveListings = async (req, res, next) => { try { ok(res, await service.getMyActiveListings(req.user.id)); } catch (e) { next(e); } };
...
module.exports = { getListings, getMyActiveListings, getListing, createListing, cancelListing, buyListing, getMessages, sendMessage };